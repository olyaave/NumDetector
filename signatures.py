...
def signature_v6_numcy_subscription_comment_add(access_token: str, cnonce: str, comment_id: int, timestamp: str):
    source = 'POSTapi.numbuster.com/api/v6/numcy/subscription/comment/addaccess_token=' + access_token + '&cnonce=' + cnonce + '&comment_id=' + str(
...
def signature_v6_comment_list_my(access_token: str, cnonce: str, limit: int, offset: int, timestamp: str):
    source = 'GETapi.numbuster.com/api/v6/comment/list/myaccess_token=' + access_token + '&cnonce=' + cnonce + '&limit=' + str(
        limit) + '&offset=' + str(offset) + '&timestamp=' + timestamp
    return crypt(source)


def signature_v6_comment_list(access_token: str, cnonce: str, limit: int, offset: int, phone: str, timestamp: str):
    source = 'GETapi.numbuster.com/api/v6/comment/listaccess_token=' + access_token + '&cnonce=' + cnonce + '&limit=' + str(
        limit) + '&offset=' + str(offset) + '&phone=' + phone + '&timestamp=' + timestamp
    return crypt(source)


def signature_v6_dailyquest_result_final(access_token: str, cnonce: str, daily_quest_id: int, timestamp: str):
    source = 'GETapi.numbuster.com/api/v6/dailyquest/result/finalaccess_token=' + access_token + '&cnonce=' + cnonce + '&daily_quest_id=' + str(
        daily_quest_id) + '&timestamp=' + timestamp
    return crypt(source)


def signature_v6_dailyquest_result(access_token: str, cnonce: str, daily_quest_id: int, opened_item: int,
                                   result_number: int, timestamp: str):
    source = 'POSTapi.numbuster.com/api/v6/dailyquest/resultaccess_token=' + access_token + '&cnonce=' + cnonce + '&daily_quest_id=' + str(
        daily_quest_id) + '&opened_item=' + str(opened_item) + '&result_number=' + str(
        result_number) + '&timestamp=' + timestamp
    return crypt(source)
...
def signature_v6_numcy_subscription_comment_renewal(access_token: str, cnonce: str, comment_id: int, timestamp: str):
    source = 'POSTapi.numbuster.com/api/v6/numcy/subscription/comment/renewalaccess_token=' + access_token + '&cnonce=' + cnonce + '&comment_id=' + str(
        comment_id) + '&timestamp=' + timestamp
    return crypt(source)
...
def signature_v6_numcy_subscription_comment_cancel(access_token: str, cnonce: str, comment_id: int, timestamp: str):
    source = 'POSTapi.numbuster.com/api/v6/numcy/subscription/comment/cancelaccess_token=' + access_token + '&cnonce=' + cnonce + '&comment_id=' + str(
        comment_id) + '&timestamp=' + timestamp
    return crypt(source)
